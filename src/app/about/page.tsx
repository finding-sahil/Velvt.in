...
export default async function AboutPage() {
  ...
  return (
    ...
    >
      ...
      {/* Hero */}
      {isSectionEnabled(settings, "about_section_hero") && (
      ...
      {/* Brand Story */}
      {isSectionEnabled(settings, "about_section_story") && (
        <section className="container-velvt mb-16">
      ...
      {/* Mission & Vision */}
      {isSectionEnabled(settings, "about_section_mission") && (
        <section className="container-velvt mb-16">
      ...
      {/* Philosophy */}
      {isSectionEnabled(settings, "about_section_philosophy") && (
