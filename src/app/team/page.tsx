                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {catMembers.map((member) => {
                    ...
                    return (
                      <div
                        key={member.id}
                        className="group relative rounded-2xl overflow-hidden bg-[#0c0c10] border border-white/[0.08] hover:border-red/50 transition-all duration-500 hover:shadow-[0_16px_40px_-10px_rgba(200,16,46,0.35)] flex flex-col justify-between p-5 min-h-[420px] sm:min-h-[440px]"
                      >
                        ...
                        <div className="relative z-10 flex items-center justify-between w-full">
                          ...
                          <span className="font-mono text-[11px] text-white/40 tracking-widest font-semibold">
                            #{String(catMembers.indexOf(member) + 1).padStart(2, "0")}
                          </span>
                        </div>

                        {/* ─── Bottom Content: Role, Name, Bio, Socials ─── */}
                        <div className="relative z-10 flex flex-col justify-end space-y-3 w-full">
                          <div className="space-y-1.5">
                            ...
                            {member.bio && (
                              <p className="text-xs text-g6 leading-relaxed line-clamp-2 opacity-80 group-hover:opacity-100 transition-opacity">
                                {member.bio}
                              </p>
                            )}
                          </div>
