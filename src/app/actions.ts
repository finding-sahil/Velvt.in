...
export async function deleteGalleryItem(id: string) {
  try {
    ...
    if (item?.url) {
      await deleteMediaAsset(item.url).catch(() => {});
    }
...
const DEFAULT_LINKTREE_CONFIG: LinkTreeConfig = {
  ...
  links: [
    {
      id: "curse-2-pass",
      title: "Book Passes — VELVT CURSE 2.O",
    ...
    {
      id: "crew-application",
      title: "Apply for Production Crew & Volunteers",
      url: "/volunteers",
    ...
    {
      id: "past-archive",
      title: "Historical Production Archive & Gallery",
      url: "/gallery",
      subtitle: "Recaps, aftermovies & photo logs from Velvet Curse",
      badge: "ARCHIVE",
      icon: "camera",
      category: "media",
      isFeatured: false,
