...
export function InstagramVerifiedBadge({ className = "w-4 h-4", size = 18 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M22.5 12c0-1.58-.875-2.95-2.148-3.6.154-.435.238-.905.238-1.4 0-2.21-1.79-4-4-4-.495 0-.965.084-1.4.238C14.55 1.975 13.18 1.1 11.6 1.1c-1.58 0-2.95.875-3.6 2.148-.435-.154-.905-.238-1.4-.238-2.21 0-4 1.79-4 4 0 .495.084.965.238 1.4C1.575 9.05.7 10.42.7 12c0 1.58.875 2.95 2.148 3.6-.154.435-.238.905-.238 1.4 0 2.21 1.79 4 4 4 .495 0 .965-.084 1.4-.238 1.45 1.273 2.82 2.148 4.4 2.148 1.58 0 2.95-.875 3.6-2.148.435.154.905.238 1.4.238 2.21 0 4-1.79 4-4 0-.495-.084-.965-.238-1.4 1.273-1.45 2.148-2.82 2.148-4.4z"
        fill="#0095F6"
      />
      <path
