  ...
  const THEME_OPTIONS = [
    {
      ...
      description: "The original signature VELVT aesthetic: deep obsidian black canvas, velvet crimson accents, and atmospheric depth.",
      accentColor: "#dc2626",
      dotColor: "rgba(220, 38, 38, 0.4)",
      bgColor: "#09090b",
      badge: "Signature Theme (Original)",
    },
    {
      id: "velvt2",
      name: "VELVT 2.O",
      tagline: "Refined Edition — Clean hierarchy, compact copy, zero lines & restrained red accents",
      description: "The complete, de-cluttered replica of the VELVT experience: compressed messaging, compact testimonials, no decorative line clutter, no cheap ambient glow, and sharp scannability.",
      accentColor: "#c8102e",
      dotColor: "rgba(255, 255, 255, 0.04)",
      bgColor: "#000000",
      badge: "Version 2.O (De-Cluttered)",
    },
  ];
