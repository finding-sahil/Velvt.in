      ...
      {isOpen && (
        ...
        >
          ...
          <a
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-mono text-white/90 hover:text-white hover:bg-white/[0.08] hover:border-white/20 border border-transparent transition-all group"
          >
          ...
          <button
            ...
            className="w-full text-left flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-mono text-white/90 hover:text-white hover:bg-white/[0.08] hover:border-white/20 border border-transparent transition-all cursor-pointer group"
          >
